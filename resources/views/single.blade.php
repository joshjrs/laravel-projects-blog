	            ...
	            <div class="col-lg-10 col-lg-offset-1">
	                <article class="hentry post post-standard-details">
	                    ...
	                    <div class="socials text-center">
	                        <!-- Go to www.addthis.com/dashboard to customize your tools --> <div class="addthis_inline_share_toolbox_vtmn"></div>
	                    </div>
	                ...
	                <div class="blog-details-author">
	                    ...
	                    <div class="blog-details-author-thumb">
	                        <img src="{{ asset($post->user->profile->avatar) }}" style="border-radius: 50%" alt="Author">
	                    </div>
	                ...
	                <div class="pagination-arrow">
	                	...
	                	@if($prev)
		                    <a href="{{ route('single', [ 'id' => $prev->slug ]) }}" class="btn-next-wrap">
	                	...
	                	@if($next)
		                    <a href="{{ route('single', [ 'id' => $next->slug ]) }}" class="btn-prev-wrap">
		                        <svg class="btn-prev">
